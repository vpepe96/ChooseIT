...
export default class D3Map extends React.Component {
  ...
  d3Init() {
    ...
    d3.json(config.apiRootUrl + '/graphs/d3/world-topo-min.json', (err, world) => {
  ...
  render() {
    return (
      <div className={this.props.className + " d3-map-container" }>
        <div className="d3-zoomin" onClick={this.zoomIn}><i className="fa fa-plus"/></div>
        <div className="d3-zoomout" onClick={this.zoomOut}><i className="fa fa-minus"/></div>
        <div className="d3-map"></div>
      </div>
    )
  }
