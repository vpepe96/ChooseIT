			...
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
					<h1 class="page-title txt-color-blueDark">
						<i class="fa fa-table fa-fw "></i> Lista aziende convenzionate
					</h1>
				</div>
			</div>
									...
									<table id="dt_basic"
										...
										<thead>
											<tr>
												<th data-class="expand"><i
													...
													Nome</th>
												<th><i
													class="fa fa-fw fa-file-pdf-o text-muted hidden-md hidden-sm hidden-xs"></i>
													Progetto formativo</th>
												<th data-hide="phone,tablet"><i
													class="fa fa-fw fa-map-marker text-muted hidden-md hidden-sm hidden-xs"></i>
													Sede legale</th>
												<th data-hide="phone,tablet"><i
													class="fa fa-fw fa fa-wrench text-muted hidden-md hidden-sm hidden-xs"></i>
													Sede operativa</th>
												<%
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<form id="dettagli" name="dettagli" method="post"
														action="<%=urlNomeAzienda %>">
														<input type="hidden" id="id_azienda" name="id_azienda"
															value="<%=azienda.getRagioneSociale()%>">
