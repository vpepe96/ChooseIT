...
/**
 * Servlet Filter implementation class TutorAziendaleFilter
 */
@WebFilter("/TutorAziendaleFilter")
public class TutorAziendaleFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    ...
    //se sono tutorAziendale posso andare
    //se non sono tutorAziendale allora dispatcher
