...
/**
 * Servlet Filter implementation class NonSegreteriaFilter
 */
@WebFilter("/NonSegreteriaFilter")
public class NonSegreteriaFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    ...
    //se non sono segreteria posso andare
    //se sono segreteria allora dispatcher
